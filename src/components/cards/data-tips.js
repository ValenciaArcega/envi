...
export const tipCards = [
  ...
  { ntc: "tip", des: "Diferencia entre could y might, ambas palabras significan 'podría', pero..." },
  { ntc: "Might", des: "Se usa para expresar bajo nivel de posibilidad y es usada de manera manera más formal" },
  ...
  { ntc: "Make", des: "Mientras que 'Make' se usa para describir expresiones del 'hacer' no físicas (imaginación)" },
  ...
  { ntc: "homophones", des: "'too' y y el número '2' son homófonos, y en contexto informal suelen sustituirse" },
  ...
  { ntc: "homophones", des: "La palabra 'hour' y la pertenencia 'our(nuestro)' se pronuncian igual: a-uohr" },
